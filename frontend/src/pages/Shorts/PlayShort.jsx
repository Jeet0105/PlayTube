...
function shuffleArray(array, shortId) {
    ...
    const pinned = array.find(item => item._id === shortId);
    const rest = array.filter(item => item._id !== shortId);
...
function PlayShort() {
    ...
    useEffect(() => {
        ...
        setShortList((prev) => (prev.length ? prev : shuffleArray(allShortData, shortId)));
    }, [allShortData, shortId]);
