        ...
        <div className="flex justify-center items-center min-h-screen bg-[#181818]">
            <div className="bg-[#202124] rounded-2xl p-10 w-full max-w-md shadow-lg">
                ...
                <div className="flex items-center mb-6">
                    ...
                    <span className="text-white text-2xl font-medium flex-1">
                        Create Account
                    </span>
                </div>
                ...
                {step === 3 && (
                    <>
                        ...
                        <button className="mt-6 w-full bg-green-600 hover:bg-green-700 transition text-white py-3 rounded-lg">
                            Create Account
                        </button>
                    </>
                )}
